...
export class RequestsService {
  ...
  // Paragraph for Parliamentarian services
  ...
  // Paragraph for Propositions services
  ...
  // Paragraph for FollowingParliamentaries Service
  ...
  // Paragraph for Most"something" services
